...
namespace CapaPresentasion
{
    public partial class frmProovedores : Form
    {
        ...
        {
            //List<Proovedor> listo = new SN_Proovedor().Listar();
            //MessageBox.Show("Proveedores cargados: " + listo.Count);
            ...
            {
                dgvData.Rows.Add(new object[] {"",item.idProovedor,item.documento,item.razonSocial,item.correo,item.telefono,
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (obj.idProovedor == 0)
            {
                int idgenerado = new SN_Proovedor().Registrar(obj, out mensaje);

                if (idgenerado != 0)
                {

                    dgvData.Rows.Add(new object[] {"",idgenerado,txtNroDocumento.Text,txtRazonSocial.Text,txtCorreo.Text,txtTelefono.Text,
            ...
            {
                bool resultado = new SN_Proovedor().Editar(obj, out mensaje);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (Convert.ToInt32(txtId.Text) != 0)
            {
                if (MessageBox.Show("¿Desea eliminar el proveedor", "Mensaje", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    bool respuesta = new SN_Proovedor().Eliminar(obj, out mensaje);
